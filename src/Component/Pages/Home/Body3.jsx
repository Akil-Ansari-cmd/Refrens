    ...
    <div>
      ...
      <div className='mt-10 flex flex-col justify-center items-center h-40 !bg-white'>
        ...
        <div className='flex mt-8 space-x-20'>
          <div><img className='w-28' src='https://assets.refrens.com/292_Your_Story_11dff8c31c.webp' /></div>
          <div><img className='w-32' src='https://assets.refrens.com/130_vccircle_01bcb68033.webp' /></div>
          <div><img className='w-32' src='https://assets.refrens.com/260_Economic_Times_dda4442926.webp' /></div>
          <div><img className='w-16' src='https://assets.refrens.com/154_Indian_Express_e0fefdb01b.webp' /></div>
        </div>
      </div>
      <div className='mt-5 py-14 flex justify-between h-36 bg-[#7D3BDF] px-28'>
      ...
      <div className='pt-5 bg-black pb-14'>
        <div className='pt-7 text-white text-4xl font-semibold flex justify-center items-center'>Features of Quotation Maker</div>
        <div className='grid grid-cols-4 px-28 gap-4 mt-10'>
          <div>
            <div><img src='https://assets.refrens.com/make_quotation_online_with_quotation_maker_bf5e4961d9.svg' /></div>
          ...
          <div>
            <div><img src='https://assets.refrens.com/Create_invoice_from_the_quotation_with_one_click_e773c94082.svg' /></div>
          ...
          <div>
            <div><img src='https://assets.refrens.com/Track_quotations_via_mail_7a3146bb60.svg' /></div>
          ...
          <div>
            <div><img src='https://assets.refrens.com/Customization_of_Quotation_and_Estimate_8765e38da3.svg' /></div>
          ...
          <div>
            <div><img src='https://assets.refrens.com/client_management_ed7174b59f.svg' /></div>
          ...
          <div>
            <div><img src='https://assets.refrens.com/lead_management_9574631513.svg' /></div>
          ...
          <div>
            <div><img src='https://assets.refrens.com/mutli_biz_owners_280a851402.svg' /></div>
          ...
          <div>
            <div><img src='https://assets.refrens.com/live_chat_bd49d97a39.svg' /></div>
      ...
      <div className='bg-[#7D3BDF] pb-24'>
        <div className='flex justify-center items-center py-8 text-5xl text-white font-semibold'>Happy Custmers</div>
        <div className='grid grid-cols-2 px-52 pt-16 gap-16'>
          <div className='border border-black rounded-lg bg-white  pb-10'>
            <div><img className='h-16 w-16  relative bottom-10 left-40' src='https://assets.refrens.com/292_Aniket_Refrens_Invoice_Software_User_eeaa17c00c.webp' /></div>
          ...
          <div className='border border-black  rounded-lg bg-white'>
            <div><img className='h-16 w-16 relative bottom-10 left-40' src='https://assets.refrens.com/406_snehal_f436be07b2.webp' /></div>
            <div className='flex flex-col px-12 justify-center items-center'>
              <div>Tally was too complicated for me. Zoho? too expensive. Refrens just hits that right sweet spot - It’s simple, It’s feature-rich, and</div>
              <div>changer</div>
          ...
          <div className='border border-black  rounded-lg bg-white pb-10'>
            <div><img className='h-16 w-16 relative bottom-10 left-40 rounded-full' src='https://assets.refrens.com/144_Nayan_ba88068972.webp' /></div>
            <div className='flex flex-col px-12 justify-center items-center'>
              <div>Tally was too complicated for me. Zoho? too expensive. Refrens just hits that right sweet spot - It’s simple, It’s feature-rich, and</div>
              <div>changer</div>
              <div  className='font-semibold'>Snehal Bhatt</div>
          ...
          <div className='border border-black  rounded-lg bg-white'>
            <div><img className='h-16 w-16 relative bottom-10 left-40  rounded-full' src='https://assets.refrens.com/108_linkee_cae93493da.webp' /></div>
            <div className='flex flex-col px-12 justify-center items-center'>
              <div>Tally was too complicated for me. Zoho? too expensive. Refrens just hits that right sweet spot - It’s simple, It’s feature-rich, and</div>
              <div>changer</div>
              <div  className='font-semibold'>Snehal Bhatt</div>
          ...
          <div className='border border-black  rounded-lg bg-white  pb-10'>
            <div><img className='h-16 w-16 relative bottom-10 left-40  rounded-full' src='https://assets.refrens.com/100_radiosparx_royalty_free_music_f299666562.webp' /></div>
            <div className='flex flex-col px-12 justify-center items-center'>
              <div>Tally was too complicated for me. Zoho? too expensive. Refrens just hits that right sweet spot - It’s simple, It’s feature-rich, and</div>
              <div>changer</div>
              <div  className='font-semibold'>Snehal Bhatt</div>
          ...
          <div className='border border-black  rounded-lg bg-white'>
            <div><img className='h-16 w-16 relative bottom-10 left-40  rounded-full' src='https://assets.refrens.com/himanshu_v2_82aa38ad14.jpeg' /></div>
            <div className='flex flex-col px-12 justify-center items-center'>
              <div>Tally was too complicated for me. Zoho? too expensive. Refrens just hits that right sweet spot - It’s simple, It’s feature-rich, and</div>
              <div>changer</div>
              <div  className='font-semibold'>Snehal Bhatt</div>
      ...
      <div className='pb-28 !bg-white shadow-sm'>
        ...
        <div className='border gap-5 py-10 shadow-lg px-10 rounded-md border-gray-200 flex flex-col justify-center mx-auto items-center w-fit p-7'>
          <div className='text-2xl'>Quotation Making on Refrens is FREE!</div>
