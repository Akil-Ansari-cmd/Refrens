    ...
    return (
        <div className='sticky z-50 top-0'>
            <div className='flex justify-between bg-[#7D3BDF] xl:px-28 lg:px-16 px-3 text-white'>
                ...
                <div className='flex lg:gap-10 gap-4 py-2'>
                    <div className='lg:flex hidden gap-1 pt-4'>
                        <div>Products</div>
                        <div><IoIosArrowDown className='mt-1.5' /></div>
                    </div>
                    <div className=' pt-4  lg:block hidden'>Pricing</div>
                    <div className='lg:flex hidden gap-2 pt-4'>
